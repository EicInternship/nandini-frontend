 ...
 const printOptions=()=>{
   return <>
    {categories.map(category=>{
      return <> <MenuItem value={category}>{category.category}</MenuItem></>
    })}
   </>
 }
  ...
  return (
    <div>
      <form onSubmit={(e)=>handelSubmit(e)}>
        ...
        >
          <Typography variant="h5" padding={1} textalign="center">Add Product</Typography>
        <TextField type ={"text"}
         value={productdata.pname} 
        onChange={(e)=>{handelchange(e,"pname")}}
        variant='outlined'
        ...
        variant='outlined'
            ...
            margin="normal"/>
        <TextField type ="Number" value={productdata.price} onChange={(e)=>{handelchange(e,"price")}}
        variant='outlined'
        ...
        <InputLabel id="demo-simple-file-label" >Upload Product Image</InputLabel>
          <TextField type={"file"} 
          variant='outlined'
          id="demo-simple-file-label"
          placeholder='Upload Product Image'
          margin="normal"onChange={(e)=>{handelimagechange(e)}} />
        <Button
        type={"submit"}
        variant='contained'
        sx={{ marginTop: 3, borderRadius: 3 }}> submit</Button>
        </Box>
      </form>
    </div>
  )
